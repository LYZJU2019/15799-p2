...
class Scenario:
    ...
    def run_ddl_and_testing_queries(self,
        ...
        try:
            ...
            created_tables, model_queries = model.create_tables(connection)  # get a list of Table and DDL queries
            queries = model.get_queries(created_tables)  # get DML queries with optimization tips from sql comments
        except Exception as e:
